...
public class AdapterVistaHistoria extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterVistaHistoria(List<Object> itemList, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_STORY) {
            ...
            view = inflater.inflate(R.layout.adapter_historia_encabezado, parent, false);
            viewHolder = new StoryViewHolder(view);
        } else if (viewType == VIEW_TYPE_CHAPTER) {
            // Inflar diseño de ViewHolder para los capítulos
            view = inflater.inflate(R.layout.adapter_historia_capitulo, parent, false);
